...
<head>
    <meta charset="utf-8">
    <title>Satgas PPKS Poltekgo</title>
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    <h1 class="display-3 animated fadeIn mb-4" style="font-size: 36px">Satuan Tugas Pencegahan dan Penanganan Kekerasan Seksual <br><span class="text-primary">Politeknik Gorontalo</span></h1>
        ...
        <div class="container-fluid bg-primary mb-5 wow fadeIn" data-wow-delay="0.1s" style="padding: 35px;">
            <div class="container">
                <div class="row g-2">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-dark border-0 w-100 py-3"><b>Search</b></button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="about-img position-relative overflow-hidden p-5 pe-0">
                            <img class="img-fluid w-100" src="{{ asset('template/index_tmpalate/gambar1.jpeg') }}">
                        </div>
                    </div>
        ...
        <!-- Form Laporan -->
        <div class="container-xxl py-5" id="lapor-form">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Sampaikan Laporan Anda</h1>
                    {{-- <p>Eirmod sed ipsum dolor sit rebum labore magna erat. Tempor ut dolore lorem kasd vero ipsum sit eirmod sit. Ipsum diam justo sed rebum vero dolor duo.</p> --}}
                </div>

                <div class="text-start mx-auto mb-5 wow fadeInUp" data-wow-delay="0.5s" id="lapor-form">
                    <div class="card">
                        <div class="card-body">
                            <form action="" method="">
                                @csrf
